<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DepartmentMaster.aspx.cs" Inherits="Admin_DepartmentMaster" %>
    ...
    <div class="row mt-20">
        ...
        <div class="shipping-checkout-page">
            <div class="row">
                <div class="col s12">
                    <div class="section-title">
                        <p><span style="color: #101010">DEPARTMENT</span> MASTER</p>
                    </div>
                </div>
            </div>
            <div class="billing-detail-wrap ck-box mt-20">
                ...
                <div class="row" style="padding-top: 20px;">
                    <div class="input-field col s6 m12 l6">
                        <asp:TextBox ID="txtDepartmentName" class="validate" runat="server" MaxLength="50"></asp:TextBox>

                        <label id="DepartName" runat="server">Enter Department Name<span style="color: red;">*</span></label>
                    </div>

                    <div class="input-field col s6 m12 l6 ">
                        <asp:TextBox ID="txtDepartmentCode" class="validate" runat="server"></asp:TextBox>
                        <label id="DepartCode" runat="server">Enter Department Code<span style="color: red;">*</span></label>
                    </div>
                </div>
            ...
            <div class="mt-20">
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-striped" AutoGenerateColumns="False"
                        AllowPaging="True" DataKeyNames="DepartmentID" PageSize="100" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                        <Columns>
        ...
        <script type="text/javascript">
            ...
            if (document.getElementById('<%=txtDepartmentCode.ClientID%>').value.trim() == "") {
