<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleDeliveryChallanPrint.aspx.cs" Inherits="SaleDeliveryChallanPrint" %>
            ...
            <table id="table11">
                        ...
                        <table style="width: 100%;" class="tab1">
                            <tr>
                                ...
                                <td style="width: 50%">
                                    <table style="width: 100%;" class="tab1">
                                        <tr>
                                            <td style="width: 50%; border-right: 1px solid black !important; font-size: large">
                                                Challan Date : -<asp:Label ID="LblChallanDate" runat="server" Text=""> </asp:Label>,
                                                <br />
                                                <%--<br />
                                                Seal No: -
                    ...
                    <ItemTemplate>
                        <tr class="tr9">
                            ...
                            <td>
                             ...
                             <td>
                                <asp:Label ID="Label6" runat="server" Text='<%#Eval("TotalTierWeight") %>'></asp:Label>
                            </td>
                             <td>
                                <asp:Label ID="Label7" runat="server" Text='<%#Eval("TotalNetWeight") %>'></asp:Label>
                            </td>
                            <td>
                ...
                <tr class="fontsize">
                    <td colspan="10">
                            ...
                            <label style="font-size: 20px; font-weight: 700"></label><br />
